...
export const de: Dict = {
  ...
  preferences: {
    ...
    dyslexicFontHint: 'Wechselt Text zu Lexend, einer Schriftart, die Lesefehler reduzieren soll.',
    ...
    spacingLabel: 'Textabstand',
    spacingHint: 'Vergrößert Zeilenhöhe, Buchstaben- und Wortabstand sowie den Abstand zwischen Absätzen auf die empfohlenen Mindestwerte für Barrierefreiheit (WCAG 1.4.12), ohne Inhalte zu verlieren.',
