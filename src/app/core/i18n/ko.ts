...
export const ko: Dict = {
  ...
  preferences: {
    kicker: '접근성',
    title: '이 사이트를 더 쉽게 읽을 수 있도록',
    lede: '이 설정은 이 기기에 저장되며 이 페이지뿐 아니라 사이트 전체에 적용됩니다.',
    fontSizeLabel: '글자 크기',
    fontSizeHint: '이 페이지뿐 아니라 사이트의 모든 제목과 문단 크기를 조절합니다.',
    decrease: '글자 작게',
    increase: '글자 크게',
    boldTextLabel: '굵은 텍스트',
    boldTextHint: '읽기 편하도록 본문 텍스트의 굵기를 높입니다. 제목은 이미 굵게 디자인되어 있어 영향을 받지 않습니다.',
    dyslexicFontLabel: '난독증 친화 글꼴',
    dyslexicFontHint: 'Lexend는 읽기 속도를 향상시킵니다. Atkinson Hyperlegible(Braille Institute 제작)은 비슷하게 생긴 글자를 더 쉽게 구분하도록 설계되었습니다.',
    dyslexicFontLexend: 'Lexend',
    dyslexicFontAtkinson: 'Atkinson Hyperlegible',
    themeLabel: '색상 테마',
    motionLabel: '애니메이션',
    motionHint: '기기의 동작 감소 설정을 넘어, 사이트 전체의 애니메이션과 전환 효과를 끕니다.',
    motionSystem: '기기 설정을 따름',
    motionReduced: '애니메이션 줄이기',
    resetButton: '기본값으로 재설정',
    navLabel: '접근성 설정',
    customizedBadge: '맞춤 설정됨',
    lineHeightLabel: '줄 높이',
    lineHeightHint: 'WCAG 1.4.12 권장 최소값 이상으로 줄 사이 간격을 넓힙니다 — 자간·단어 간격과는 별개로 적용됩니다.',
    charSpacingLabel: '자간 및 단어 간격',
    charSpacingHint: 'WCAG 1.4.12 권장 최소값 이상으로 글자와 단어 사이 간격을 넓힙니다.',
    previewKicker: '미리보기',
    previewHeading: '예시 제목',
    previewParagraph: '위 설정을 변경하면 이 문단이 실시간으로 업데이트되어, 이 페이지를 벗어나기 전에 글자 크기, 굵기, 간격, 글꼴이 실제 콘텐츠에 어떤 영향을 주는지 정확히 확인할 수 있습니다.',
    previewParagraph2: '두 번째 문단입니다. 여러 텍스트 블록에서 효과가 얼마나 일관되게 나타나는지 비교할 수 있습니다 — 간격, 굵기, 글꼴은 사이트 어디에서나 동일하게 적용됩니다.',
  },
  footer: {
    github: 'GitHub',
    copyEmail: '이메일 복사',
