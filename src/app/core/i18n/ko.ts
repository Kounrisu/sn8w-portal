...
export const ko: Dict = {
  ...
  aboutSection: {
    kicker: '소개',
    title: '제 경력에 대해 조금',
    lede: '파리 근교에 기반을 둔 프론트엔드 Angular 개발자입니다. 2015년부터 유럽 중앙은행의 공용 컴포넌트 라이브러리를 설계하고 유지보수해 왔습니다 — Angular 4에서 21까지의 마이그레이션, RGAA/WCAG 접근성, CI/CD 파이프라인, 그리고 이를 사용하는 팀들에 대한 일상적인 지원. 개발로 전향하기 전에는 영국과 미국에서 10년 동안 산업 현장의 지속적 개선을 이끌었습니다. 방법론과 문서화, 부서를 넘나드는 협업에 대한 애착은 그때 생긴 것입니다.',
    timelineLabel: '경력',
    timeline: [
      {
        period: '2015년 — 현재',
