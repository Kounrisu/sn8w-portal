...
export const fr: Dict = {
  ...
  preferences: {
    ...
    dyslexicFontHint: 'Remplace le texte par Lexend, une police conçue pour réduire les erreurs de lecture.',
    ...
    spacingLabel: 'Espacement du texte',
    spacingHint: "Augmente la hauteur de ligne, l'espacement des lettres et des mots, ainsi que l'espace entre les paragraphes, jusqu'aux minimums recommandés pour l'accessibilité (WCAG 1.4.12), sans perte de contenu.",
