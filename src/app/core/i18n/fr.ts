...
export const fr: Dict = {
  ...
  nav: {
    ...
    preferences: "Paramètres d'accessibilité",
  },
  hero: {
    kicker: 'Paris, France',
  ...
  sitemap: {
    ...
    lede: "Une liste simple de toutes les pages, pour les lecteurs qui préfèrent cela à la navigation.",
    home: 'Accueil',
    publicSection: 'Pages publiques',
  ...
  preferences: {
    ...
    title: 'Rendre ce site plus facile à lire',
    lede: "Ces réglages sont enregistrés sur cet appareil et s'appliquent partout sur le site, pas seulement ici.",
    fontSizeLabel: 'Taille du texte',
    fontSizeHint: 'Modifie tous les titres et paragraphes du site, pas seulement cette page.',
    decrease: 'Texte plus petit',
    increase: 'Texte plus grand',
    boldTextLabel: 'Texte plus épais',
    boldTextHint: "Augmente la graisse du texte courant pour une lecture plus facile. Les titres ne sont pas concernés — ils sont déjà en gras par nature.",
    dyslexicFontLabel: 'Police adaptée à la dyslexie',
    dyslexicFontHint: 'Lexend améliore la vitesse de lecture. Atkinson Hyperlegible (conçue par le Braille Institute) est conçue pour mieux distinguer les caractères qui se ressemblent.',
    dyslexicFontLexend: 'Lexend',
    dyslexicFontAtkinson: 'Atkinson Hyperlegible',
    themeLabel: 'Thème de couleurs',
    motionLabel: 'Animations',
    motionHint: "Désactive les animations et transitions sur tout le site, au-delà de ce que le réglage de réduction des animations de votre appareil couvre déjà.",
    motionSystem: 'Suivre mon appareil',
    motionReduced: 'Réduire les animations',
    resetButton: 'Réinitialiser',
    navLabel: "Paramètres d'accessibilité",
    customizedBadge: 'personnalisé',
    lineHeightLabel: 'Interligne',
    lineHeightHint: "Augmente l'espacement entre les lignes, jusqu'au minimum recommandé par le WCAG 1.4.12 et au-delà — indépendant de l'espacement des caractères.",
    charSpacingLabel: 'Espacement des caractères',
    charSpacingHint: "Augmente l'espacement entre les lettres et les mots, jusqu'au minimum recommandé par le WCAG 1.4.12 et au-delà.",
    previewKicker: 'Aperçu',
    previewHeading: 'Un exemple de titre',
    previewParagraph: "Ce paragraphe se met à jour en direct quand vous modifiez les réglages ci-dessus, pour que vous puissiez voir exactement comment la taille, la graisse, l'espacement et la police du texte affectent un contenu réel avant de quitter cette page.",
    previewParagraph2: "Un second paragraphe, pour comparer la cohérence de l'effet sur plusieurs blocs de texte — l'espacement, la graisse et la police s'appliquent ici de la même façon que partout ailleurs sur le site.",
  },
  footer: {
    github: 'GitHub',
