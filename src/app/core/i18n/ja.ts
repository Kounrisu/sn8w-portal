...
export const ja: Dict = {
  ...
  preferences: {
    ...
    dyslexicFontHint: 'Lexendは読む速度を改善します。Atkinson Hyperlegible(Braille Institute制作)は似た形の文字を区別しやすくするよう設計されています。',
    ...
    lineHeightLabel: '行の高さ',
    lineHeightHint: 'WCAG 1.4.12が推奨する最小値以上に行間を広げます。文字間隔とは独立して適用されます。',
    charSpacingLabel: '文字・単語の間隔',
    charSpacingHint: 'WCAG 1.4.12が推奨する最小値以上に文字と単語の間隔を広げます。',
    previewKicker: 'プレビュー',
    previewHeading: '見出しの例',
    previewParagraph: 'この段落は上の設定を変更するとその場で更新されるため、このページを離れる前に文字サイズ、太さ、間隔、フォントが実際のコンテンツにどう影響するかを確認できます。',
    previewParagraph2: '2つ目の段落です。複数のテキストブロックで効果がどれだけ一貫しているか比較できます。間隔、太さ、フォントはサイトのどこでも同じように適用されます。',
  },
  footer: {
    github: 'GitHub',
    copyEmail: 'メールをコピー',
