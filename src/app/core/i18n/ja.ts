...
export const ja: Dict = {
  ...
  aboutSection: {
    kicker: '自己紹介',
    title: 'これまでの経歴について',
    lede: 'パリ近郊を拠点とするフロントエンド Angular 開発者です。2015年から、ヨーロッパの中央銀行の共有コンポーネントライブラリの設計・保守を担当しています — Angular 4 から 21 への移行、RGAA/WCAG アクセシビリティ、CI/CD パイプライン、そしてそれを使う各チームへの日々のサポート。開発に移る前は、イギリス、そしてアメリカで10年間、製造業の現場 — 自動車から化粧品、そして眼鏡用ポリカーボネートレンズまで — で継続的改善を推進していました。手法・ドキュメント・部門を超えた仕事へのこだわりは、その頃に身についたものです。',
    timelineLabel: '職務経歴',
    timeline: [
      {
        period: '2015年 — 現在',
